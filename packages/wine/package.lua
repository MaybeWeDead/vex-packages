return {
  ...
  arch    = "x86_64",
  deps    = { "alsa-lib", "dbus", "fontconfig", "freetype", "gnutls", "libX11", "libXcomposite", "libXcursor", "libXext", "libXfixes", "libXi", "libXinerama", "libXrandr", "libXrender", "libxcb", "llvm-mingw", "make", "pulseaudio", "sdl2", "vulkan-loader", "wayland", "xkbcommon" },
  build   = function(p)
